    ...
    <header class="sticky top-0 z-50 w-full border-b bg-primary text-primary-foreground">
      <div class="container mx-auto flex h-16 items-center px-4">
        ...
        <nav class="ml-10 flex gap-6">
          <a routerLink="/" routerLinkActive="text-yellow-400" [routerLinkActiveOptions]="{exact:true}"
             class="text-sm font-medium flex items-center gap-2 hover:text-yellow-400 transition-colors">
